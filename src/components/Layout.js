...
const TemplateWrapper = ({ children }) => (
  <div>
    <Helmet htmlAttributes={{ lang: 'en' }}>
      ...
      <meta
        name="description"
        content="WieCare is a veteran-led 501(c)(3) charitable non-profit that focuses on teaching
    veterans how to program free of charge so that they may find gainful employment after service."
      ...
      <meta
        ...
        content="WieCare is a veteran-led 501(c)(3) charitable non-profit that focuses on
